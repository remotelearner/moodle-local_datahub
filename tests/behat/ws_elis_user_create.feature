...
Feature: Web service requests can be made to create a user.
    ...
    # T33.26.1 #11
    Scenario: Creation validates multi-valued custom field parameters.
        Given A multi-valued custom field exists with name "custom1" for the "user" context with options "Option 1, Option 2, Option 3, Option 4"
        ...
        Then I should receive from the datahub web service:
        """
        {"messagecode":"user_created","message":"User created with custom field errors - see logs for details.","record":{"username":"test2","password":"","idnumber":"test2","firstname":"First","lastname":"Last2","mi":null,"email":"test2@example.com","email2":null,"address":"","address2":null,"city":"","state":null,"postalcode":null,"country":"CA","phone":null,"phone2":null,"fax":null,"birthdate":null,"gender":null,"language":"en","transfercredits":0,"comments":null,"notes":null,"inactive":false,"field_custom1":?}}
        """
